    ...
    <section class="breadcrumb-section set-bg" data-setbg="ATNtoy/Bagr.jpg">
        <div class="container">
            <div class="row">
	...
	<?php
		...
		if(isset($_POST['btnAdd']))
		{
			...
			else
			{
				...
				{
					pg_query($conn, "insert into branch (branch_id, branch_name, address) values ('$id', '$name', '$address')");
